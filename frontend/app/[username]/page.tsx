...
import { BoardPreviewProvider } from '@/provider/board-preview-provider'
import { PinProvider } from '@/provider/pin-provider'
...
export default async function ProfilePage({ params }: { params: Promise<{ username: string }> }) {
	...
	return (
		<PinProvider pins={pins}>
			<BoardPreviewProvider boardPreview={boards}>
